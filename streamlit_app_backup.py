...
# ======================================================================
    ...
    st.markdown("### Deep-Dive Analysis: Select Country + Commodity for Comprehensive Insights")
    ...
    # === 7-8 COMPREHENSIVE VISUALIZATIONS WITH DATA SCIENTIST EXPLANATIONS ===
    ...
    fig_monthly_eda = px.line(
        ...
        x='Date',
        y='Value',
        title=f'Monthly Import Trend: {selected_commodity_eda} from {selected_country_eda}',
    ...
    <p><b>Key insights to look for:</b></p>
    <ul>
        <li><b>Trend Direction:</b> Is the series growing, declining, or stable over time?</li>
        <li><b>Volatility:</b> Large fluctuations indicate unstable supply/demand or price sensitivity</li>
        <li><b>Cyclical Patterns:</b> Regular peaks and troughs suggest seasonal business cycles</li>
        <li><b>Anomalies:</b> Sudden spikes or drops warrant investigation (policy changes, market shocks)</li>
    </ul>
